'''
    30 September 2020 : 
    Welcome to Cryptic Mirror, a story based action-adventure 2D platformer game.
    Developed by Adarsh , Aashish and Ananth, from DAV Senior Secondary School,
    in a time span of approximately 2 years.
...
obstacles_trap = (((-700, -600), (-600, 600), (5381, 5381), (100, 100)),
                ((0,0),(-300 , -251),(4925 , 5391),(100 , 100)),
                ((0,0),(-300 , -161),(4650 , 4835),(100 , 100)),
                ((0,0),(-300 , -261),(3905 , 4573),(100 , 100)),
                ((0,0),(-300 , -211),(3780 , 3925),(100 , 100)),
                ((0,0),(-300 , -161),(3623 , 3800),(100 , 100)),
                ((0,0),(-300 , -211),(3486 , 3643),(100 , 100)),
                ((0,0),(-300 , -211),(3146 , 3288),(100 , 100)),
                ((0,0),(-300 , -161),(3009 , 3156),(100 , 100)),
                ((0,0),(-300 , -111),(2860 , 3029),(100 , 100)),
                ((0,0),(-300 , -261),(-2176 , 2662),(100 , 100)),
                ((0,0),(-300 , -211),(709 , 892),(100 , 100)),
                ((0,0),(-300 , -151),(431 , 605),(100 , 100)),
                ((0,0),(-300 , -211),(140 , 310),(100 , 100)),
                ((0,0),(-300 , -151),(-139 , 30),(100 , 100)),
                ((0,0),(-300 , -211),(-416 , -242),(100 , 100)),
                ((0,0),(-300 , -151),(-950 , -780),(100 , 100)),
                ((0,0),(-300 , -151),(-1238 , -1069),(100 , 100)),
                ((0,0),(-300 , -151),(-1610 , -1358),(100 , 100)),
                ((0,0),(-300 , -151),(-1912 , -1740),(100 , 100)),
                ((0,0),(-300 , -151),(-2196 , -2030),(100 , 100)),
                ((0,0),(-300 , -261),(-4275 , -2453),(100 , 100)),
                ((0,0),(-300 , -261),(-5400 , -4497),(100 , 100)), 
                ((600, 700), (-600, 600), (-5399, -5399), (100, 100)))
...
((0, 0), (-260, -235), (605, 709), (100, 100)),((0, 0), (-260, -235), (310, 431), (100, 100)),((0, 0), (-260, -235), (30, 140), (100, 100)),((0, 0), (-260, -235), (-242, -139), (100, 100)),((0, 0), (-300, -275), 
(-2453, -2196), (100, 100)), ((0, 0), (-300, -275), (-4497, -4275), (100, 100))) 
...
obstacles_prac = (((-700, -600), (-600, 600), (5398, 5398), (100, 100)),
             ((0, 0), (-350, -251), (4295, 6150), (100, 100)),
             ((0, 0), (-350, -181), (4295, 4506), (100, 100)), 
             ((0, 0), (-200, -51), (3896, 4091), (100, 100)),
             ((0, 0), (-350, -261), (2195, 3777), (100, 100)), 
             ((0, 0), (-350, -181), (2050, 2196), (100, 100)),
             ((0, 0), (-350, -106), (1595, 2051), (100, 100)),
             ((0, 0), (-350, -181), (1427, 1596), (100, 100)), 
             ((0, 0), (-350, -301), (1226, 1428), (100, 100)),
             ((0, 0), (-350, -251), (408, 1227), (100, 100)),
             ((0, 0), (-350, -251), (-275, 251), (100, 100)),
             ((0, 0), (-300, -117), (-620, -394), (100, 100)),
             ((0, 0), (-350, -251), (-3655, -769), (100, 100)), 
             ((0, 0), (180, 600), (-1888, -769), (100, 100)),
             ((0, 0), (-350, -251), (-4464, -3654), (100, 100)),
             ((0, 0), (-350, -251), (-5392, -4463), (100, 100)), 
             ((600, 700), (-600, 600), (-4001, -4001), (100, 100)))
...
def credits():
    ...
    p11.goto(-300, 0)
    p11.write("A  D.A.V  ORIGINAL", False, font=("Bookman Old Style", 50))
    ...
    name_list = ['Adarsh', 'Aashish', 'Ananth']
    name = ''
    for x in range(3):
    ...
    for x in range(150):
        if x == 25:
            p12.write("Our Mentor", False, font=("Tekton Pro", 35,"bold"))
            p11.write("Uma Arthi Ma'am", False, font=("Tekton Pro", 60, "bold", "italic"))  # select * from
        elif x == 125:
            p12.clear()
            p11.clear()
        p_larger1.fd(2)
    ...
    for x in range(150):
        if x == 25:
            p12.write("Always motivating us to improve...", False, font=("Tekton Pro", 35,"italic"))
            p11.write("Class XII C", False, font=("Tekton Pro", 50, "bold", "italic"))
        elif x == 125:
            p11.clear()
            p12.clear()
            p13.clear()

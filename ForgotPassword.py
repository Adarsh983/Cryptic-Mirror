'''
    This is a module defined to send e-mail to users who forget their password.
'''
...
def MailNow(TO, NICKNAME, gmail_passwd , PASSWORD):
    ...
    gmail_sender = 'mirrorcryptic@gmail.com'
...
<body style="font-family: arial;">
    ...
    <left style="color: blue; font-family: consolas; font-size: 85%";>mirrorcryptic@gmail.com</left>
